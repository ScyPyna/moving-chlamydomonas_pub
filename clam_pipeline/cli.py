...
def _save_merged(all_outputs: dict[int, object], run_dir: Path) -> None:
    ...
    fields = ["theta", "theta_y", "theta_x", "theta_y_only", "flux", "angle", "omega",
...
def main(
    ...
    for exp_id in exp_ids:
        ...
        save_df_csv(outputs.theta_x,              out_exp_dir / "theta_x.csv")
        save_df_csv(outputs.theta_y_only,         out_exp_dir / "theta_y_only.csv")
        ...
        _save_legacy_txt(outputs.theta_x,        flat_results_dir / f"ThetaX_exp{exp_id}.txt",      "theta_x dist\n")
        _save_legacy_txt(outputs.theta_y_only,   flat_results_dir / f"ThetaY_only_exp{exp_id}.txt", "theta_y dist\n")
